...
enum Flip: String, CaseIterable, Identifiable {
    ...
    var description: String {
        ...
        case .kickflip: return "Flip in a kickflip like way to the right. Flip it on the long side"
        case .heelflip: return "Flip in a kickflip like way to the left. Flip it on the long side"
        case .threeSixty: return "Rotate 360 degrees clockwise."
        case .reverseThreeSixty: return "Rotate 360 degrees counter-clockwise"
        case .full: return "This is a 360 + a heelflip. Flip while spinning. Push the top right corner towards you."
        case .inverseFull: return "This is a 360 + a kickflip. Flip inwards with your thumb on the bottom right corner."
        }
    }
